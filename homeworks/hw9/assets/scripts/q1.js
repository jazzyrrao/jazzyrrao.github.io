...
function setBackgroundColor(color) {
    ...
    let thebcolor = document.getElementById("q1-container")
    thebcolor.style.backgroundColor = color
}
...
function redButtonClicked() {
    ...
    let redb = document.getElementById("q1-btn-red")
    redb.classList.toggle("red")
}
...
function yellowButtonClicked() {
    ...
    let yellowb = document.getElementById("q1-btn-yellow")
    yellowb.classList.toggle("yellow")
}
...
function greenButtonClicked() {
    ...
    let greenb = document.getElementById("q1-btn-green")
    greenb.classList.toggle("green")
}
...
function lightblueButtonClicked() {
    ...
    let lightblueb = document.getElementById("q1-btn-lightblue")
    lightblueb.classList.toggle("lightblue")
}
...
function blueButtonClicked() {
    ...
    let blueb = document.getElementById("q1-btn-blue")
    blueb.classList.toggle("blue")
}
